...
This a list of game dev tools, what I think their "genre" or "specialty" is, along with a description
...
3. Autodesk Maya(3d Modeling) https://www.autodesk.com/products/maya/overview
   ...
   Pros:
     Industry standard
     Powerful 3d modeler that allows for limitless creation
...
5. RPGMaker(Codeless Game Engine) https://www.rpgmakerweb.com/
   ...
   Pros:
   Good for those without programming experience
...
7. Blender(3d modeling) https://www.blender.org/
   ...
   Pros:
   Free
   Powerful and versatile like the paid counterpart
   Large community, lots of available help
...
9. aseprite(2d Pixel art) https://www.aseprite.org/
   ...
   Perfect for pixel art projects
...
13. Visual Studio Code(Coding) https://code.visualstudio.com/download?_exp_download=d53503e735
    ...
    Lots of coding languages available
...
15. Twine(Text based Game Engine) https://twinery.org/
    ...
    Free
    Beginner friendly
    Doesn't require a lot of programming skill
    Good for branching stories, as that is what it was designed for
...
19. FL Studio(Sound Design) https://www.image-line.com/fl-studio/download
    ...
    Lots of instruments and effects
    Useful for both beginners and advanced sound artists

    Cons:
    Paid(Beginners pay around 99$ for the base tier, not including all features, and up to 449$ for all the features. These are lifetime though)
